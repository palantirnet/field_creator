...
the features module chop_prototypical_fields_feature. It also reads in a csv
...
chop_prototypical_fields_feature and chop_prototypical_field_instances_feature.
3. Update chop_fields_creator_get_prototypical_fields_by_type() and
chop_fields_creator_get_prototypical_field_instances_by_type();
